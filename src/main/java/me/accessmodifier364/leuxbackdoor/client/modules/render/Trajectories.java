...
public class Trajectories extends Module {
    ...
    Setting green = create("Green", "Green", 50, 0, 255);
    Setting blue = create("Blue", "Blue", 50, 0, 255);
    ...
    public void render(EventRender renderEvent) {
        if (mc.player == null || mc.world == null)
            return;

        double renderPosX = mc.player.lastTickPosX + (mc.player.posX - mc.player.lastTickPosX) * renderEvent.get_partial_ticks();
        double renderPosY = mc.player.lastTickPosY + (mc.player.posY - mc.player.lastTickPosY) * renderEvent.get_partial_ticks();
        double renderPosZ = mc.player.lastTickPosZ + (mc.player.posZ - mc.player.lastTickPosZ) * renderEvent.get_partial_ticks();
        ...
        GlStateManager.color(red.get_value(1) / 255f, green.get_value(1) / 255f, blue.get_value(1) / 255f, alpha.get_value(1) / 255f);
