...
public class MathUtil {
    ...
    public static float[] calc_Angle(Vec3d from, Vec3d to) {
    ...
    public static float[] legit_rotation(Vec3d pos) {
        ...
        return new float[]{mc.player.rotationYaw +
                MathHelper.wrapDegrees(player_yaw - mc.player.rotationYaw), mc.player.rotationPitch +
                MathHelper.wrapDegrees(player_pitch - mc.player.rotationPitch)};
    }
    ...
    public static double[] movement_speed(double speed) {
        ...
        double pos_x = forward * speed * cos + side * speed * sin;
        double pos_z = forward * speed * sin - side * speed * cos;
