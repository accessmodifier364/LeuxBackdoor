...
public class RenderUtil3 implements Globals {
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air) {
        IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil3.mc.world.getWorldBorder().contains(pos)) {
            Vec3d interp = EntityUtil.interpolateEntity(RenderUtil3.mc.player, mc.getRenderPartialTicks());
            RenderUtil3.drawBlockOutline(iblockstate.getSelectedBoundingBox(RenderUtil3.mc.world, pos).grow(0.002f).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }

    public static void drawBlockOutlineBB(AxisAlignedBB bb, Color color, float linewidth) {
        Vec3d interp = EntityUtil.interpolateEntity(RenderUtil3.mc.player, mc.getRenderPartialTicks());
        RenderUtil3.drawBlockOutline(bb.grow(0.002f).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
    }
    ...
    public static void drawBox(BlockPos pos, Color color, boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil3.mc.world.getWorldBorder().contains(pos)) {
            Vec3d interp = EntityUtil.interpolateEntity(RenderUtil3.mc.player, mc.getRenderPartialTicks());
            AxisAlignedBB bb = iblockstate.getSelectedBoundingBox(RenderUtil3.mc.world, pos).grow(0.002f).offset(-interp.x, -interp.y, -interp.z);
            camera.setPosition(Objects.requireNonNull(RenderUtil3.mc.getRenderViewEntity()).posX, RenderUtil3.mc.getRenderViewEntity().posY, RenderUtil3.mc.getRenderViewEntity().posZ);
            if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil3.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil3.mc.getRenderManager().viewerPosZ))) {
                GlStateManager.pushMatrix();
                GlStateManager.enableBlend();
                GlStateManager.disableDepth();
                GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static void drawGradientBlockOutline(BlockPos pos, Color startColor, Color endColor, float linewidth, double height) {
        IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity(RenderUtil3.mc.player, mc.getRenderPartialTicks());
        drawGradientBlockOutline(iblockstate.getSelectedBoundingBox(RenderUtil3.mc.world, pos).grow(0.002f).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0), startColor, endColor, linewidth);
    }
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air, double height, boolean gradient, boolean invert) {
        ...
        IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil3.mc.world.getWorldBorder().contains(pos)) {
            AxisAlignedBB blockAxis = new AxisAlignedBB((double) pos.getX() - RenderUtil3.mc.getRenderManager().viewerPosX, (double) pos.getY() - RenderUtil3.mc.getRenderManager().viewerPosY, (double) pos.getZ() - RenderUtil3.mc.getRenderManager().viewerPosZ, (double) (pos.getX() + 1) - RenderUtil3.mc.getRenderManager().viewerPosX, (double) (pos.getY() + 1) - RenderUtil3.mc.getRenderManager().viewerPosY + height, (double) (pos.getZ() + 1) - RenderUtil3.mc.getRenderManager().viewerPosZ);
    ...
    public static void drawGradientPlane(BlockPos pos, EnumFacing face, Color startColor, Color endColor, double height) {
        ...
        IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity(RenderUtil3.mc.player, mc.getRenderPartialTicks());
        AxisAlignedBB bb = iblockstate.getSelectedBoundingBox(RenderUtil3.mc.world, pos).grow(0.002f).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0);
        float red = (float) startColor.getRed() / 255.0f;
        float green = (float) startColor.getGreen() / 255.0f;
        float blue = (float) startColor.getBlue() / 255.0f;
        float alpha = (float) startColor.getAlpha() / 255.0f;
    ...
    public static void drawBox(BlockPos pos, Color color, double height, boolean gradient, boolean invert, int alpha) {
        ...
        AxisAlignedBB bb = new AxisAlignedBB((double) pos.getX() - RenderUtil3.mc.getRenderManager().viewerPosX, (double) pos.getY() - RenderUtil3.mc.getRenderManager().viewerPosY, (double) pos.getZ() - RenderUtil3.mc.getRenderManager().viewerPosZ, (double) (pos.getX() + 1) - RenderUtil3.mc.getRenderManager().viewerPosX, (double) (pos.getY() + 1) - RenderUtil3.mc.getRenderManager().viewerPosY + height, (double) (pos.getZ() + 1) - RenderUtil3.mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(RenderUtil3.mc.getRenderViewEntity()).posX, RenderUtil3.mc.getRenderViewEntity().posY, RenderUtil3.mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil3.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil3.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    public static void drawBBBox(AxisAlignedBB BB, Colour colour, int alpha) {
        AxisAlignedBB bb = new AxisAlignedBB(BB.minX - RenderUtil3.mc.getRenderManager().viewerPosX, BB.minY - RenderUtil3.mc.getRenderManager().viewerPosY, BB.minZ - RenderUtil3.mc.getRenderManager().viewerPosZ, BB.maxX - RenderUtil3.mc.getRenderManager().viewerPosX, BB.maxY - RenderUtil3.mc.getRenderManager().viewerPosY, BB.maxZ - RenderUtil3.mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(RenderUtil3.mc.getRenderViewEntity()).posX, RenderUtil3.mc.getRenderViewEntity().posY, RenderUtil3.mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil3.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil3.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, Colour color, int alpha, int sides) {
        ...
        GlStateManager.pushMatrix();
        glBillboardDistanceScaled((float) pos.getX() + 0.5f, (float) pos.getY() + 0.5f, (float) pos.getZ() + 0.5f, RenderUtil3.mc.player, 1.0f);
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) ModLoader.latoFont.getStringWidth(text) / 2.0), 0.0, 0.0);
        if (custom) {
            ModLoader.latoFont.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        } else {
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double) x - RenderUtil3.mc.getRenderManager().renderPosX, (double) y - RenderUtil3.mc.getRenderManager().renderPosY, (double) z - RenderUtil3.mc.getRenderManager().renderPosZ);
    ...
    public static void drawGlError(BlockPos pos, double height, double length, double width, Color color) {
        ...
        AxisAlignedBB bb = new AxisAlignedBB((double) pos.getX() - RenderUtil3.mc.getRenderManager().viewerPosX, (double) pos.getY() - RenderUtil3.mc.getRenderManager().viewerPosY,
                (double) pos.getZ() - RenderUtil3.mc.getRenderManager().viewerPosZ,
                (double) (pos.getX() + 1) - RenderUtil3.mc.getRenderManager().viewerPosX,
                (double) (pos.getY() + 1) - RenderUtil3.mc.getRenderManager().viewerPosY, (double) (pos.getZ() + 1) - RenderUtil3.mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(RenderUtil3.mc.getRenderViewEntity()).posX, RenderUtil3.mc.getRenderViewEntity().posY, RenderUtil3.mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil3.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil3.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil3.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil3.mc.getRenderManager().viewerPosZ))) {
