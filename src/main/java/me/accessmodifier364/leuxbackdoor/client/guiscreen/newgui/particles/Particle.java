...
public class Particle {
    ...
    public static Particle generateParticle() {
        ...
        float size = (float) (Math.random() * ModLoader.get_setting_manager().get_setting_with_tag("Particles", "Size").get_value(1.0)) + 1.0f;
    ...
    public float getDistanceTo(float f, float f2) {
        return (float) GuiParticles.distance(this.getX(), this.getY(), f, f2);
    }
